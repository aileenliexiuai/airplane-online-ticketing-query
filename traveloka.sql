...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2024 at 10:01 AM
...
INSERT INTO `customer` (`CustomerID`, `FirstName`, `LastName`, `Email`, `Phone`, `gender`) VALUES
('C0001', 'Felice', 'Felice', 'felice@binus.ac.id', '80939393939', 'F'),
('C0002', 'Aileen', 'Angelica Lee', 'aileen.lee@binus.ac.id', '81234567891', 'F'),
('C0003', 'Richard', 'Wijaya Harianto', 'richard.harianto@binus.ac.id', '81234567892', 'M'),
('C0004', 'Agung', 'Trivaldo Saputra', 'agung.saputra@binus.ac.id', '81234567893', 'M'),
('C0005', 'Davin', 'Nayaka Pandya', 'davin.pandya@binus.ac.id', '81234567894', 'M'),
('C0006', 'Nico', 'Himawan', 'nico.himawan@binus.ac.id', '81234567895', 'M'),
('C0007', 'Steven', 'Liu', 'steven.liu@binus.ac.id', '81234567896', 'M'),
('C0008', 'Achmad', 'Hafidz', 'achmad.hafidz@binus.ac.id', '81234567897', 'M'),
('C0009', 'Alvin', 'Divanno', 'alvin.divanno@binus.ac.id', '81234567898', 'M'),
('C0010', 'Alfin', 'Syahgaf Rifai', 'alfin.rifai@binus.ac.id', '81234567899', 'M'),
('C0031', 'haha', 'juicy', 'hahahajuicy', '923232323', 'M'),
('C0043', 'alin', 'alina', 'alinalin@gmail.com', NULL, 'F'),
('C0047', 'budi', 'budiman', 'budiman@gmail.com', NULL, 'M'),
('C0090', 'LALA', 'ULALA', 'ulala@gmail.com', NULL, 'F');
...
('PR011', 'TP011', 'BISNIS', 332.3),
('PR012', 'TP011', 'EKONOMI', 115.389);
...
ALTER TABLE `harga`
  ...
  ADD KEY `idx_harga_transport` (`transportID`);
